    ...
    : QWidget()
{
    ...
    QString copyrightText   = QString::fromUtf8((CopyrightHolders(strprintf("\xc2\xA9 %u-%u ", 2009, COPYRIGHT_YEAR)) + "\n\xc2\xA9 2014-2024 The Bitmark Core developers").c_str());
    ...
    QRect rectIcon(QPoint(10,10), QSize(300,280));
