...
struct Dersig720Setup : public TestChain100Setup {
    Dersig720Setup()
...
BOOST_FIXTURE_TEST_CASE(tx_mempool_block_doublespend, Dersig720Setup)
{
...
BOOST_FIXTURE_TEST_CASE(checkinputs_test, Dersig720Setup)
{
