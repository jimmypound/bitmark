...
BITCOIND=${BITCOIND:-$BINDIR/bitmarkd}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/bitmark.conf}
...
then
  ...
  echo -e "To safely generate a bitmark.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example bitmark.conf file in share/examples/'
...
##
## bitmark.conf configuration file.
## Generated by contrib/devtools/gen-bitmark-conf.sh.
##
...
# parse the output from bitmarkd --help
